...
void loop()
{
...

  {
    ...
    if (mfrc522[reader].PICC_IsNewCardPresent() && mfrc522[reader].PICC_ReadCardSerial())
    {
      ...
      if (mfrc522[reader].uid.uidByte[0] == 0xA2 &
          mfrc522[reader].uid.uidByte[1] == 0x29 &
          mfrc522[reader].uid.uidByte[2] == 0x9F &
          mfrc522[reader].uid.uidByte[3] == 0x1E &
          reader == 0 )
      {
        Serial.println("0-s kartya oke");
        a++;
      }
      if (mfrc522[reader].uid.uidByte[0] != 0xE3 &
          mfrc522[reader].uid.uidByte[1] != 0xBF &
          mfrc522[reader].uid.uidByte[2] != 0x62 &
          mfrc522[reader].uid.uidByte[3] != 0x30 &
          reader != 0)
      {
